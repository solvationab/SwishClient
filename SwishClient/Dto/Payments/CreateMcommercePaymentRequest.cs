...
{
    /// <summary>
    /// A request to create a new M-commerce payment
    /// </summary>
    public class CreateMcommercePaymentRequest
    {
        /// <summary>
        ...
        public CreateMcommercePaymentRequest(
        ...
        /// <summary>
        /// Payment reference of the payee, wich is the merchant that receives the payment. This reference could be order id or similar. Allowed characters are a-z A-Z 0-9 - and lenght must be between 1 and 35 characters.
        /// </summary>
